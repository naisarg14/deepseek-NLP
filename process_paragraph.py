...
protected_words = {"api", "AI", "openai", "tensorflow"}

spell = SpellChecker(distance=1)
spell.word_frequency.load_words(protected_words)
...
def process_paragraph(paragraph):
    ...
    corrected_tokens = [lemmatizer.lemmatize(word if word in protected_words else correct(word)) for word in tokens]
